...
public class BoardPanel extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        if (game.isGameOver() || game.isNewGame() || game.isPaused()) {
            ...
            if (game.isNewGame()) {
                largeMessage = "GAME STUDIO - Snake Game!";
             ...
             */
            g.setFont(FONT);
            g.drawString(largeMessage, centerX - g.getFontMetrics().stringWidth(largeMessage) / 2, centerY - 40);
            g.drawString(smallMessage, centerX - g.getFontMetrics().stringWidth(smallMessage) / 2, centerY + 20);
        }
    }
